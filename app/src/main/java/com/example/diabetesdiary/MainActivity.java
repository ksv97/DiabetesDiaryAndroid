...
/* TODO
    ...
    * Нарисовать линии коридора глюкозы в статистике (добавить две LineSeries?)
    * Поместить кнопку к правому нижнем углу, но чтоб не заезжало за лист(!!)
    * Пофиксить баг со статистикой за разный период
    *
